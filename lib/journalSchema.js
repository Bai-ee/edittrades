 ...
 * {positionIdHash, ticketNonce, openJournalId, fillSource}, short id-like strings or null.
 * It is appended after RECORD_KEYS when present.
 */
...
export const EXEC_REF_FIELDS = Object.freeze(['positionIdHash', 'ticketNonce', 'openJournalId', 'fillSource']);
