 ...
 */
export function alertLogLine(alert, { payload, id, sentAtMs, silent, level, trackedIds = new Set(), delivered = true, suppressed = null }) {
  ...
  return {
    ...
    suppressed: typeof suppressed === 'string' ? suppressed : null,
