...
import { readRiskPolicyConfig, applyRiskPrefs, evaluateRiskPolicy } from './riskPolicy.js';
import {
  ...
  async function preflight(intent, ctx = {}) {
    ...
    try {
      ...
      const order = {
        ...
        exposurePct: riskPolicy.exposurePct, symbolExposurePct: riskPolicy.symbolExposurePct,
