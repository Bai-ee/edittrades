...
// 10 s: an ETag-guarded Blob append with retries routinely exceeds 3 s, and at 3 s the
// first live open's phase records (submitted/landed/filled) and the stops error were all
// dropped as `timeout` (2026-09-26), leaving no trace of why the stops failed.
