...
export const COMMANDS = Object.freeze(['start', 'help', 'signals', 'why', 'flags', 'wallet', 'journal', 'status', 'chart', 'log', 'testalert', 'alerts']);
...
export default {
  ...
  formatAlertPrefs, fmtQuiet, parseAlertsArgs, parseQuietSpec, normalizePrefs, applyPrefsChange, chicagoHour,
