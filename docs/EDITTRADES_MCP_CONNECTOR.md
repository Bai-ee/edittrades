...
Last updated: 2026-09-23 (Phase 2 recommendation completeness, schema 1.18.0)
Branch: `upgrade-signal-engine`
Payload: `schemaVersion` 1.8.0, `configVersion` 2026.09.22-6 live; 1.18.0 / 2026.09.23-7 local (Phases 9, 10, 9b, trading-model quick pass Q1-Q3, F1 flag detection coverage, signal-reliability minimum plan, 21/200 decision clarity, review fix pass, P1 Pyth mark, owner decisions 1 + 4, Phase 2 recommendation completeness); 1.18.0 not deployed
