...
Last updated: 2026-09-23 (P1 Pyth mark, schema 1.16.0)
Branch: `upgrade-signal-engine`
Payload: `schemaVersion` 1.8.0, `configVersion` 2026.09.22-6 live; 1.16.0 / 2026.09.23-5 local (Phases 9, 10, 9b, trading-model quick pass Q1-Q3, F1 flag detection coverage, signal-reliability minimum plan, 21/200 decision clarity, review fix pass, P1 Pyth mark), not deployed
