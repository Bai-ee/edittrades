...
Last updated: 2026-09-24 (T4 P1 pathOutlook, schema 1.19.0)
Branch: `upgrade-signal-engine`
Payload: `schemaVersion` 1.8.0, `configVersion` 2026.09.22-6 live; 1.19.0 / 2026.09.24-1 local (Phases 9, 10, 9b, trading-model quick pass Q1-Q3, F1 flag detection coverage, signal-reliability minimum plan, 21/200 decision clarity, review fix pass, P1 Pyth mark, owner decisions 1 + 4, Phase 2 recommendation completeness, T4 P1 pathOutlook); 1.19.0 not deployed
